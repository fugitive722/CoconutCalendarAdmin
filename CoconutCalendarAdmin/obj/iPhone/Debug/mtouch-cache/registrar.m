...
native_to_managed_trampoline_escoz_MonthGridView_TouchesBegan (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_47, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldInteractWithTextAttachment (id this, SEL sel, id p0, id p1, NSRange p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_129, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingEnded (id this, SEL sel, id p0, id p1, float p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_139, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingStarted (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_141, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_CoconutCalendarAdmin_CoconutPickDateMonthViewController__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_145));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_SizingSource_GetHeightForRow (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_148, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_BeginTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_171, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_EndTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_172, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
static MTClass __monotouch_classes [] = {
	...
	{"CoconutCalendarAdmin.CoconutCalendarAppointmentSource", "NSObject", 1, 4, 0},
...
int __monotouch_map_count = 114;
static int __monotouch_class_count = 48;
